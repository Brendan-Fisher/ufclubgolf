    ...
    render() {
        return (
            <div>
                ...
                <div id="container" className="container valign-wrapper white">
                    <div id="content" className="row">
                        <div className="flexbox">
                            <div id="box" className="col s12 l12 m12 top-align">
                                    <h4>
                            ...
                            <div id="box" className="col s12 center-align white">
                                <h2>Calendar</h2>
